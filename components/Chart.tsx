...
//     for (let i = 0; i < 520; i++) { // ~520 trading days in 2 years
...
//   // Scale functions
//   const getX = (index) => padding + (index * ((width - padding - rightPadding) / (data.length - 1)));
...
//         {/* Date labels */}
//         {data.filter((_, i) => i % 60 === 0).map((point, index) => (
//           <text
//             key={index}
//             x={getX(index * 60)}
//             y={height - padding + 20}
...
//             fill="transparent"
//             onMouseEnter={() => setHoveredPoint({ point, x: getX(index), y: getY(point.price) })}
